...
dotnet publish `
  ...
  -o "*Path*\PublishOutput"





*( -p:PublishSingleFile=true ) powoduje, że plików jest dużo mniej, jednak sam plik exe ma ponad 160 MB co powoduje, że nie można go wgrać na GitHub.com(max100MB) 
